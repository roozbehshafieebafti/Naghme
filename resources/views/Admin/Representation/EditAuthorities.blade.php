			...
			<form class="form" method="post" action="" style="padding: 20px 0" enctype="multipart/form-data">
				...
				<div class="row">
				  ...
				  <div class="form-group">
				    <label >رزومه:</label>
				    <textarea id="representaion_cv" style="resize: none" required="required" name="Authorities_cv" class="form-control text-left" >{{ $EditableAuthorities->authorities_cv }}</textarea>
				  </div>
				  <div class="form-group">
				    <label >عکس:</label>
