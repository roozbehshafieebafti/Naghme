			...
			<form class="form" method="post" action="" style="padding: 20px 0" enctype="multipart/form-data">
                ...
                <div class="row mt-3">
                    ...
                    <div class="form-group col-md-4">
                        <label >تاریخ :</label>
                        <input type="text" name="Post_Date" id="Date_Input" class="form-control text-left"  value="{{ $executeDate[0]."/".($executeDate[1]<10 ? '0'.$executeDate[1] : $executeDate[1])."/".($executeDate[2]<10 ? '0'.$executeDate[2] : $executeDate[2]) }}" required="required" onchange="DateValidation(event)">
                    </div>
                    ...
                    <div class="form-group col-4">
                        ...
                        <input type="file" onchange="PostPictureCheck(this.id)" id="Post_Mobile_Picture" name="Post_Mobile_Picture" class="form-control text-left"  >
                    </div>                    
                </div>
                <div class="row mt-3">
                    <div class="form-group col-4">
                        <label >تصویر کاور :</label>
                        <input type="file" onchange="PostPictureCheck(this.id)" id="Post_Cover_Picture" name="Post_Cover_Picture" class="form-control text-left"  >
                    </div>
                    <div class="pt-4 pr-3" style="margin-top:5px;">
                        ...
                        <span style="display:inline-block;margin-right:20px;">
                            <input type="checkbox" name="isLandescape" id="isLandescape" style="transform: scale(1.3)" {{$Post['attributes']['apst_is_cover_picture_landscape'] == 1 ? 'checked' : ""}}/>
                        </span>
                    </div>
                </div>
