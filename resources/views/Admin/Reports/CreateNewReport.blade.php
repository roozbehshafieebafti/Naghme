...
@section('title','ایجاد پرسشنامه جدید')

@section('content')
	<div class="container" style="direction: rtl;padding: 20px 0">
        <h2>ایجاد پرسشنامه جدید</h2>
		<div>
			@if(count($errors)>0)
			...
			<form class="form" method="post" action="" style="padding: 20px 0">
                ...
                <div class="form-group">
                    ...
                    <input type="text"  name="New_Report" class="form-control col-8 text-left" placeholder="نام پرسشنامه را اینجا وارد کنید">
                    <small class="pl-2">حداکثر 100 کارکتر</small>
                </div>
                <div>
                    <button class="btn btn-success">ثبت پرسشنامه</button>
